...
public class TicketService {
	...
	//Books ticket uses load balancing and circuitBreaker
	@CircuitBreaker(name="ticketService",fallbackMethod = "bookticketFallback")
	public TicketDTO bookticket(String flightId, String userId,
		...
		FlightDTO flightDTO=restTemplate.getForObject("http://FlightMS/infygo/flights/details/"+flightId,FlightDTO.class);
		ticket.setPnr(pnr);
	...
	//Alternate method for bookticket if circuit goes in open state
	public TicketDTO bookticketFallback(String flightId, String userId,
			Set<PassangerDTO> passangers,String creditCardNumber,Throwable throwable) {
